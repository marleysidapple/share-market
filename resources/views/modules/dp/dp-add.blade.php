...
@section('main-content')
  ...
  <div class="panel panel-default">
      <div class="panel-heading">
          <h3 class="panel-title"><strong>Add New Depository Participants(DP)</strong></h3>
      </div>
      <div class="panel-body">
          {!! Form::open(array('url'=>'dp/add', 'role'=>'form', 'method'=>'POST', 'class'=>'form-horizontal', 'id'=>'dpForm')) !!}
