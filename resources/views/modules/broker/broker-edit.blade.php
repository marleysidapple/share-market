...
@section('main-content')
  ...
  <div class="panel panel-default">
      ...
      <div class="panel-body">
          {!! Form::open(array('url'=>'broker/edit', 'role'=>'form', 'method'=>'POST','class'=>'form-horizontal', 'id'=>'brokerForm')) !!}
              ...
              <div class="form-group {{ $errors->has('broker_no') ? ' has-error' : '' }}">
                  <label class="col-md-3 col-xs-12 control-label">Broker Number *</label>
                  <div class="col-md-6 col-xs-12">
                    <input type="text" id="broker_no" name="broker_no" class="form-control" value="{{$pageData->broker_no}}"/>
