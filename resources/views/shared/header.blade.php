    ...
    <!-- TASKS -->
    <!--<li class="xn-icon-button pull-right">
        <a href="index.html#"><span class="fa fa-tasks"></span></a>
    ...
    <!-- LANG BAR -->
    <!--<li class="xn-icon-button pull-right">
        <a href="index.html#"><span class="flag flag-gb"></span></a>
        <ul class="xn-drop-left xn-drop-white animated zoomIn">
            <li><a href="index.html#"><span class="flag flag-gb"></span> English</a></li>
            <li><a href="index.html#"><span class="flag flag-de"></span> Deutsch</a></li>
            <li><a href="index.html#"><span class="flag flag-cn"></span> Chinese</a></li>
        </ul>
    </li>-->
    <!-- END LANG BAR -->
